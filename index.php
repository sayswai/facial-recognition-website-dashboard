    ...
    <div class="collapse navbar-collapse" id="navbarContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active disabled">
                <!-- First item active by default, unfinished so also disabled (ironic). Add main page link, and auto-scroll functionality -->
            ...
            <?php if (!isset($_SESSION['username'])) { ?>
                <li class="nav-item">
                    <!-- Not yet implemented, therefor disabled for now. Create popup form for account management -->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <p>Need an account?</p>
                <button class="btn btn-primary" data-toggle="modal" data-target="#signForm" data-dismiss="modal">Sign
                    Up
                </button>
            </div>
        </div>
            ...
            <div class="modal-body" id="signUpBody">
                <form class="form-horizontal" role="form" method="" action="php-functions/user.php" id="signUpForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" name="repas" placeholder="Repeat Password"
                               id="repas">
                    </div>
                    <div class="form-group">
